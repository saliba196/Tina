...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD22634);
  late Color secondary = const Color(0xFF008000);
  late Color tertiary = const Color(0xFFFFF2FC);
  late Color alternate = const Color(0xFF080402);
  late Color primaryText = const Color(0xFF080402);
  late Color secondaryText = const Color(0xFF677681);
  late Color primaryBackground = const Color(0xFFFFF2FC);
  late Color secondaryBackground = const Color(0xFFBDECB6);
  late Color accent1 = const Color(0xFFD9D9D9);
  late Color accent2 = const Color(0xFF4A4846);
  late Color accent3 = const Color(0xFF748494);
